...
-- Description:	Lay diem danh cua danh sach nhan vien theo bo phan cua QuanLyId (theo ngay)
-- =============================================
CREATE PROCEDURE [dbo].[sp_LayDiemDanhBoPhanId]
	@QuanLyId INT,
	@Ngay DATE
AS
BEGIN
